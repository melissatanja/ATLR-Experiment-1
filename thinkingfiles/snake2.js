...
function headtop(){
		...
		beginShape();
			vertex(x, y, z);
			vertex(x + 8, 44, (i * 1.5) + 6);
			vertex(x + 16, 50 + yht[i + 1], z);
		endShape();
...
function head(){
	...
	beginShape();
		vertex(xpos[0] - 7.5, y, zpos[0] + 7.5);
		vertex(xpos[0] - 10, mid, zpos[0]);
		vertex(xpos[0] - 5, ypos[0] + yht[i + 1], zpos[0]);
	endShape(CLOSE);
